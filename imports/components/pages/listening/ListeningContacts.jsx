...
class ListeningContacts extends Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
    ...
    if(this.props.contacts) {
      ...
      return (
        <div className="listening-info-block">
          <h2 className="medium-headline">{t('listening.contacts')}</h2>
...
export default translate('common', { wait: true }) (ListeningContacts);